          ...
          {!scores ? (
            <>
              ...
              <button
                ...
                className="w-full mt-4 py-3 bg-[#1A1A1A] text-white rounded-xl font-medium hover:bg-[#3A4A38] disabled:opacity-50 transition-colors flex items-center justify-center gap-2"
              >
                {loading ? (
              ...
              <div className="relative">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-b from-transparent via-white/80 to-white dark:via-[#222920]/80 dark:to-[#222920]">
                  ...
                  <Link href="/login?ref=demo">
                    <button className="mt-3 px-6 py-2 bg-[#88B078] text-[#1A1A1A] rounded-full text-sm font-semibold hover:bg-[#78A068] transition-colors">
                      Crear cuenta gratis
                    </button>
                  </Link>
                </div>
