...
export function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-[#E8E8E8]">
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              ...
              <span className={cn("text-[10px] font-medium whitespace-nowrap", active ? "text-[#88B078]" : "")}>{t(item.labelKey, locale)}</span>
            </Link>
          )
        })}
        <ThemeToggleCompact />
