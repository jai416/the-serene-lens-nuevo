...
export default function QuickFeedback({ analysisId, onComplete }: Props) {
  ...
  if (submitted) {
    return (
      <div className="mt-6 rounded-xl bg-[#F8F9FA] p-4 text-center">
    ...
    <div className="mt-6 rounded-xl bg-[#F8F9FA] p-4 text-center">
      ...
      <div className="flex justify-center gap-4">
        ...
        <button
          ...
          disabled={loading}
          className="rounded-lg bg-gray-200 px-6 py-2 font-medium transition-colors hover:bg-gray-300 disabled:opacity-50"
        >
          👎 No
        </button>
      </div>
