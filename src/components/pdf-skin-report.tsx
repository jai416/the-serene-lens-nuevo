...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: "bold", marginBottom: 20, color: "#2F3A2D" },
  subtitle: { fontSize: 14, color: "#64705E", marginBottom: 10 },
  section: { marginBottom: 20 },
  sectionTitle: { fontSize: 16, fontWeight: "bold", marginBottom: 10, color: "#2F3A2D", borderBottomWidth: 1, borderBottomColor: "#C2E09D", paddingBottom: 5 },
  row: { flexDirection: "row", marginBottom: 5 },
  label: { width: 120, fontSize: 10, color: "#64705E" },
  value: { flex: 1, fontSize: 10, color: "#2F3A2D" },
  badge: { backgroundColor: "#C2E09D", borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2, alignSelf: "flex-start", marginBottom: 5 },
  badgeText: { fontSize: 9, color: "#2F3A2D" },
  listItem: { flexDirection: "row", marginBottom: 4, paddingLeft: 10 },
  bullet: { width: 8, fontSize: 10, color: "#C2E09D" },
  text: { fontSize: 10, color: "#2F3A2D", lineHeight: 1.5 },
  routineStep: { flexDirection: "row", marginBottom: 6, paddingLeft: 10 },
  stepNumber: { width: 20, height: 20, borderRadius: 10, backgroundColor: "#C2E09D", textAlign: "center", lineHeight: 20, fontSize: 10, color: "#2F3A2D", marginRight: 8 },
  stepText: { flex: 1, fontSize: 10, color: "#2F3A2D", lineHeight: 1.4 },
  footer: { position: "absolute", bottom: 30, left: 40, right: 40, borderTopWidth: 1, borderTopColor: "#DDE7D3", paddingTop: 10 },
  footerText: { fontSize: 8, color: "#64705E", textAlign: "center" },
  comparisonRow: { flexDirection: "row", borderBottomWidth: 1, borderBottomColor: "#F0F5EC", paddingVertical: 4 },
  comparisonLabel: { width: 100, fontSize: 9, color: "#64705E" },
  comparisonPrev: { width: 120, fontSize: 9, color: "#9BAA93" },
  comparisonCurrent: { flex: 1, fontSize: 9, color: "#2F3A2D" },
