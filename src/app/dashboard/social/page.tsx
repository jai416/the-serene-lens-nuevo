    ...
    <div className="min-h-screen px-4 py-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-[#666666] dark:text-[#9BAA93] mt-1 text-sm">
        ...
        <Card className="p-6 mt-6">
          <CardContent className="p-0">
            <h2 className="font-serif text-lg font-semibold mb-3 text-[#1A1A1A] dark:text-[#E8DED5]">
              ¿Cómo funciona?
            </h2>
            <ul className="space-y-2 text-sm text-[#666666] dark:text-[#9BAA93]">
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-[#88B078] text-[#1A1A1A] text-xs flex items-center justify-center shrink-0 mt-0.5">1</span>
                <span>Invita a tus amigos a unirse con tu código de referido</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-[#88B078] text-[#1A1A1A] text-xs flex items-center justify-center shrink-0 mt-0.5">2</span>
                <span>Tus resultados se comparan de forma anónima por tipo de piel</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="w-5 h-5 rounded-full bg-[#88B078] text-[#1A1A1A] text-xs flex items-center justify-center shrink-0 mt-0.5">3</span>
