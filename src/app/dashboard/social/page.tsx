...
export default function SocialPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center">
      ...
      <h1 className="text-2xl font-bold text-[#1A1A1A] mb-2">Social</h1>
      <p className="text-[#666666] max-w-md">
        Próximamente podrás comparar tus resultados de forma anónima con amigos y ver tu progreso junto al de ellos.
      </p>
    </div>
  )
}
