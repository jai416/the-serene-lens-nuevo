...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* ─── Hero ─── */}
      <section className="relative min-h-[90vh] flex items-center py-20 px-4 sm:px-8 overflow-hidden bg-gradient-to-b from-[#F8FAF5] via-[#FFFAF5] to-white dark:from-[#1A1F19] dark:via-[#211C17] dark:to-[#1A1612]">
        <div className="max-w-7xl mx-auto w-full">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="animate-fade-in-up max-w-xl">
              ...
              <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold leading-[1.08] mb-6 text-[#2F3A2D] dark:text-[#E8DED5]">
                Conoce mejor
                <br />
                tu piel
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Link href={session ? "/analysis" : "/login"}>
                  <button className="inline-flex items-center justify-center text-base font-semibold transition-all bg-[#2F3A2D] text-white px-8 py-6 rounded-full shadow-[0_4px_16px_rgba(61,50,41,0.25)] hover:shadow-[0_8px_24px_rgba(61,50,41,0.35)] hover:bg-[#4D3F35]">
                    <Scan className="w-4 h-4 mr-2" />
                    Comenzar Análisis
                  </button>
                </Link>
                <Link href="#how-it-works">
                  <button className="inline-flex items-center justify-center text-base font-semibold transition-all bg-white dark:bg-[#2A2520] text-[#2F3A2D] dark:text-[#E8DED5] px-8 py-6 rounded-full border-2 border-[#D4C5B5] dark:border-[#4A3F35] hover:bg-[#F8FAF5] dark:hover:bg-[#322A22]">
                    Ver cómo funciona
              ...
              <p className="text-xs text-[#9BAA93] dark:text-[#64705E] mt-4">
            ...
            <div className="hidden lg:flex items-center justify-center animate-fade-in relative" style={{ animationDelay: "300ms" }}>
              <div className="relative w-full max-w-[420px] aspect-[4/5]">
                ...
                <div className="absolute -bottom-6 -left-6 w-36 h-36 rounded-full bg-[#F8FAF5]/80" />
                ...
                <div className="relative w-full h-full rounded-[32px] bg-white dark:bg-[#22201C] border border-[#DDE7D3] dark:border-[#222920] shadow-[0_4px_20px_rgba(61,50,41,0.08)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.3)] p-8 flex flex-col items-center justify-center">
                  <div className="w-24 h-24 rounded-full bg-[#F8FAF5] dark:bg-[#322A22] flex items-center justify-center mb-6 border-2 border-[#C2E09D]">
                    <Flower2 className="w-12 h-12 text-[#2F3A2D]" />
                  </div>

                  <h3 className="font-serif text-xl font-semibold text-[#2F3A2D] dark:text-[#E8DED5] mb-2 text-center">
                  ...
                  <div className="flex items-center gap-3 mt-6">
                    <div className="w-8 h-8 rounded-full bg-[#F8FAF5] flex items-center justify-center">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {actionCards.map((card, i) => (
              <Link key={card.title} href={card.href}>
                <Card
                  className="p-5 transition-all duration-300 hover:shadow-[0_8px_24px_rgba(61,50,41,0.1)] hover:-translate-y-1 cursor-pointer animate-fade-in-up h-full border-t-4 border-t-[#2F3A2D] dark:border-t-[#C2E09D]"
                ...
                >
                  <CardContent className="p-0">
                    ...
                    <h3 className="font-serif text-base font-semibold text-[#2F3A2D] dark:text-[#E8DED5] mb-1">{card.title}</h3>
      ...
      {/* ─── How It Works ─── */}
      <section id="how-it-works" className="py-20 sm:py-28 px-4 sm:px-8 bg-[#F8FAF5] dark:bg-[#1A1F19]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-14">
            <Badge variant="secondary" className="mb-4 rounded-full px-4 py-1.5">
              Proceso Simple
            </Badge>
            <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-semibold mb-4 text-[#2F3A2D] dark:text-[#E8DED5]">
              ¿Cómo Funciona?
            </h2>
            ...
            {steps.map((step, i) => (
              ...
              >
                <CardContent className="p-0">
                  ...
                  <h3 className="font-serif text-xl font-semibold mb-3 text-[#2F3A2D] dark:text-[#E8DED5]">{step.title}</h3>
            ...
            {features.map((f, i) => (
              <Card key={f.title} className="p-6 animate-fade-in-up" style={{ animationDelay: `${i * 100}ms` }}>
                <CardContent className="p-0">
                  ...
                  <h3 className="font-serif text-lg font-semibold mb-2 text-[#2F3A2D] dark:text-[#E8DED5]">{f.title}</h3>
      ...
      {/* ─── Quick Skin Test ─── */}
      <section className="py-16 sm:py-24 px-4 sm:px-8 bg-[#F8FAF5] dark:bg-[#1A1F19]">
        <div className="max-w-3xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-10">
            <Badge variant="secondary" className="mb-4 rounded-full px-4 py-1.5">
              Mini Test
            </Badge>
            <h2 className="font-serif text-3xl sm:text-4xl font-semibold mb-4 text-[#2F3A2D] dark:text-[#E8DED5]">
      ...
      {/* ─── Pricing Preview ─── */}
      <section className="py-20 sm:py-28 px-4 sm:px-8 bg-[#F8FAF5] dark:bg-[#1A1F19]">
              ...
              >
                <CardContent className="p-0 flex flex-col h-full">
                  ...
                  <div className="text-center mb-6">
                    <p className="text-lg font-semibold mb-1 text-[#2F3A2D] dark:text-[#E8DED5]">{p.name}</p>
                    <div className="flex items-baseline justify-center gap-1">
                      <span className={`font-bold text-[#2F3A2D] dark:text-[#E8DED5] ${p.popular ? "text-3xl" : "text-2xl"}`}>{p.price}</span>
      ...
      <section className="pb-20 text-center px-4">
        <p className="text-xs text-[#9BAA93] dark:text-[#64705E] max-w-lg mx-auto leading-relaxed">
