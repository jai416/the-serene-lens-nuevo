...
Con esta guía podrás leer cualquier etiqueta y tomar decisiones informadas sobre lo que aplicas en tu piel.`,
  ...
  const products = [
    ...
    { name: "Protector Solar SPF 50+", slug: "protector-solar-spf-50", description: "Protección solar de amplio espectro SPF 50+. Textura ligera que no deja residuo blanco. Resistente al agua por 40 minutos.", shortDesc: "Protección solar alta, textura ligera", image: productImage("Protector Solar SPF 50+", "proteccion-solar"), category: "proteccion-solar", skinTypes: "all", price: 18.99, ingredients: "Óxido de Zinc, Dióxido de Titanio, Vitamina E, Aloe Vera, Ácido Hialurónico", isActive: true },
    { name: "Sérum Vitamina C 15%", slug: "serum-vitamina-c-15", description: "Sérum con Vitamina C estabilizada al 15% para iluminar y unificar el tono de la piel.", shortDesc: "Ilumina y unifica el tono", image: productImage("Sérum Vitamina C 15%", "serums"), category: "serums", skinTypes: "normal,mixta,seca,madura", price: 24.99, ingredients: "Ácido Ascórbico, Vitamina E, Ácido Ferúlico, Ácido Hialurónico", isActive: true },
    { name: "Crema Hidratante con Ácido Hialurónico", slug: "crema-hidratante-acido-hialuronico", description: "Crema hidratante ligera con ácido hialurónico de triple peso molecular. Hidratación profunda sin sensación grasa.", shortDesc: "Hidratación profunda, textura ligera", image: productImage("Crema Hidratante AH", "hidratantes"), category: "hidratantes", skinTypes: "normal,mixta,grasa", price: 16.99, ingredients: "Ácido Hialurónico, Glicerina, Escualano, Ceramidas, Pantenol", isActive: true },
    { name: "Contorno de Ojos con Cafeína", slug: "contorno-ojos-cafeina", description: "Contorno de ojos revitalizante con cafeína y péptidos. Reduce bolsas y ojeras, ilumina la mirada.", shortDesc: "Revitaliza y reduce ojeras", image: productImage("Contorno Ojos Cafeína", "contornos"), category: "contornos", skinTypes: "all", price: 19.99, ingredients: "Cafeína, Péptidos, Ácido Hialurónico, Vitamina C, Alantoína", isActive: true },
    { name: "Exfoliante Químico AHA 10%", slug: "exfoliante-quimico-aha-10", description: "Exfoliante químico con AHA al 10%. Renueva la textura, reduce manchas y unifica el tono.", shortDesc: "Renovación y luminosidad", image: productImage("Exfoliante AHA 10%", "exfoliantes"), category: "exfoliantes", skinTypes: "normal,mixta,madura", price: 22.99, ingredients: "Ácido Glicólico, Ácido Láctico, Aloe Vera, Vitamina E, Glicerina", isActive: true },
    { name: "Mascarilla de Arcilla Purificante", slug: "mascarilla-arcilla-purificante", description: "Mascarilla con caolín y bentonita que absorbe el exceso de grasa y purifica los poros.", shortDesc: "Purifica y minimiza poros", image: productImage("Mascarilla Arcilla", "mascarillas"), category: "mascarillas", skinTypes: "grasa,mixta", price: 14.99, ingredients: "Caolín, Bentonita, Extracto de Té Verde, Aloe Vera, Aceite de Árbol de Té", isActive: true },
    { name: "Aceite Facial Noche con Retinol", slug: "aceite-facial-noche-retinol", description: "Aceite nocturno con retinol encapsulado y escualano. Regenera la piel mientras duermes.", shortDesc: "Regeneración nocturna", image: productImage("Aceite Noche Retinol", "aceites"), category: "aceites", skinTypes: "normal,seca,madura", price: 28.99, ingredients: "Escualano, Retinol Encapsulado, Vitamina E, Aceite de Jojoba, Aceite de Rosa Mosqueta", isActive: true },
    { name: "Sérum Niacinamida 10%", slug: "serum-niacinamida-10", description: "Sérum con niacinamida al 10% y zinc. Regula sebo, minimiza poros y fortalece la barrera.", shortDesc: "Regula sebo y fortalece la barrera", image: productImage("Sérum Niacinamida", "serums"), category: "serums", skinTypes: "grasa,mixta", price: 20.99, ingredients: "Niacinamida, Zinc PCA, Glicerina, Ácido Hialurónico", isActive: true },
    ...
    { name: "Tónico Equilibrante con Niacinamida", slug: "tonico-equilibrante-niacinamida", description: "Tónico con niacinamida y ácido hialurónico que equilibra el pH y cierra poros.", shortDesc: "Equilibra y prepara la piel", image: productImage("Tónico Niacinamida", "hidratantes"), category: "hidratantes", skinTypes: "normal,mixta,grasa", price: 15.99, ingredients: "Niacinamida, Ácido Hialurónico, Aloe Vera, Panthenol, Allantoin", isActive: true },
    { name: "Mascarilla Hidratante Overnight", slug: "mascarilla-hidratante-overnight", description: "Mascarilla de noche con ceramidas y escualano que repara la barrera cutánea mientras duermes.", shortDesc: "Reparación nocturna intensiva", image: productImage("Mascarilla Overnight", "mascarillas"), category: "mascarillas", skinTypes: "seca,madura,normal", price: 24.99, ingredients: "Ceramidas, Escualano, Ácido Hialurónico, Vitamina E, Manteca de Karité", isActive: true },
    { name: "Sérum Retinol 0.5%", slug: "serum-retinol-05", description: "Sérum con retinol encapsulado al 0.5%. Anti-edad suave para principiantes en retinoides.", shortDesc: "Anti-edad suave para empezar", image: productImage("Sérum Retinol 0.5%", "serums"), category: "serums", skinTypes: "normal,mixta,madura", price: 26.99, ingredients: "Retinol Encapsulado, Vitamina E, Escualano, Aceite de Jojoba", isActive: true },
    { name: "Aceite de Rosa Mosqueta Puro", slug: "aceite-rosa-mosqueta", description: "Aceite puro de rosa mosqueta orgánico. Regenera, hidrata y reduce manchas e cicatrices.", shortDesc: "Regeneración y reparación natural", image: productImage("Aceite Rosa Mosqueta", "aceites"), category: "aceites", skinTypes: "seca,madura,normal", price: 22.99, ingredients: "Aceite de Rosa Mosqueta (100% puro, orgánico)", isActive: true },
    ...
    { name: "Mascarilla de Carbón Activado", slug: "mascarilla-carbon-activado", description: "Mascarilla con carbón activado que absorbe toxinas y impurezas profundas de los poros.", shortDesc: "Limpieza profunda de poros", image: productImage("Mascarilla Carbón", "mascarillas"), category: "mascarillas", skinTypes: "grasa,mixta", price: 13.99, ingredients: "Carbón Activado, Caolín, Extracto de Té Verde, Aloe Vera", isActive: true },
    { name: "Contorno de Ojos Antiojeras", slug: "contorno-ojos-antiojeras", description: "Contorno de ojos con vitamina K y péptidos que reduce ojeras oscuras y bolsas.", shortDesc: "Reduce ojeras y bolsas", image: productImage("Contorno Antiojeras", "contornos"), category: "contornos", skinTypes: "all", price: 24.99, ingredients: "Vitamina K, Péptidos, Cafeína, Ácido Hialurónico, Vitamina C", isActive: true },
    { name: "Tónico Exfoliante con Ácido Salicílico", slug: "tonico-exfoliante-acido-salicilico", description: "Tónico exfoliante con BHA al 2% para piel grasa y con tendencia acnéica.", shortDesc: "Exfoliación y control de grasa", image: productImage("Tónico BHA", "hidratantes"), category: "hidratantes", skinTypes: "grasa,mixta", price: 17.99, ingredients: "Ácido Salicílico 2%, Glicerina, Aloe Vera, Niacinamida", isActive: true },
    { name: "Sérum Ácido Hialurónico + B5", slug: "serum-acido-hialuronico-b5", description: "Sérum hidratante con ácido hialurónico de bajo y alto peso molecular más pantenol (B5).", shortDesc: "Hidratación molecular profunda", image: productImage("Sérum AH + B5", "serums"), category: "serums", skinTypes: "all", price: 19.99, ingredients: "Ácido Hialurónico, Pantenol (Vitamina B5), Glicerina", isActive: true },
    { name: "Crema Anti-edad con Péptidos", slug: "crema-anti-edad-peptidos", description: "Crema anti-edad con péptidos de cobre, retinol y ceramidas. Firmeza y elasticidad.", shortDesc: "Firmeza y elasticidad", image: productImage("Crema Anti-edad", "hidratantes"), category: "hidratantes", skinTypes: "madura,seca", price: 32.99, ingredients: "Péptidos de Cobre, Retinol, Ceramidas, Escualano, Vitamina E", isActive: true },
    ...
    { name: "Mascarilla Vitaminada SOS", slug: "mascarilla-vitaminada-sos", description: "Mascarilla exprés con vitaminas C, E y B5 para piel apagada y fatigada.", shortDesc: "Energía y luminosidad inmediata", image: productImage("Mascarilla Vitaminada", "mascarillas"), category: "mascarillas", skinTypes: "all", price: 16.99, ingredients: "Vitamina C, Vitamina E, Vitamina B5, Aloe Vera, Ácido Hialurónico", isActive: true },
    { name: "Aceite Multifunción Dry Oil", slug: "aceite-multifuncion-dry-oil", description: "Aceite seco multifunción para cara, cuerpo y cabello. Absorción rápida, sin sensación grasa.", shortDesc: "Triple用途, absorción rápida", image: productImage("Aceite Multifunción", "aceites"), category: "aceites", skinTypes: "all", price: 18.99, ingredients: "Aceite de Jojoba, Aceite de Argán, Aceite de Rosa Mosqueta, Vitamina E", isActive: true },
    { name: "Sérum Depigmentante con Arbutina", slug: "serum-depigmentante-arbutina", description: "Sérum despigmentante con alfa-arbutina y vitamina C para manchas oscuras e hiperpigmentación.", shortDesc: "Reduce manchas y unifica tono", image: productImage("Sérum Arbutina", "serums"), category: "serums", skinTypes: "normal,mixta,madura", price: 27.99, ingredients: "Alfa-Arbutina, Vitamina C, Niacinamida, Ácido Hialurónico", isActive: true },
    { name: "Protector Solar Tintado FPS 50", slug: "protector-solar-tintado-fps50", description: "Protector solar mineral tintado SPF 50 con cobertura ligera. Ideal como base.", shortDesc: "Protección + maquillaje en uno", image: productImage("Solar Tintado FPS50", "proteccion-solar"), category: "proteccion-solar", skinTypes: "all", price: 23.99, ingredients: "Óxido de Zinc, Dióxido de Titanio, Pigminos Minerales, Vitamina E", isActive: true },
    { name: "Crema Hidratante Oil-Free", slug: "crema-hidratante-oil-free", description: "Hidratante sin aceite para piel grasa. Textura gel que no obstruye poros.", shortDesc: "Hidratación sin brillo", image: productImage("Crema Oil-Free", "hidratantes"), category: "hidratantes", skinTypes: "grasa,mixta", price: 15.99, ingredients: "Ácido Hialurónico, Niacinamida, Aloe Vera, Glicerina", isActive: true },
    ...
    { name: "Mascarilla Colágeno Marino", slug: "mascarilla-colageno-marino", description: "Mascarilla con colágeno marino y ácido hialurónico para piel madura y sin firmeza.", shortDesc: "Firmeza y elasticidad", image: productImage("Mascarilla Colágeno", "mascarillas"), category: "mascarillas", skinTypes: "madura,seca", price: 19.99, ingredients: "Colágeno Marino, Ácido Hialurónico, Vitamina E, Escualano", isActive: true },
    { name: "Sérum Vitamina C + Ferulic", slug: "serum-vitamina-c-ferulic", description: "Sérum avanzado con Vitamina C al 20% y ácido ferúlico para máxima estabilidad y efectividad.", shortDesc: "Antioxidante máximo", image: productImage("Sérum Vitamina C+", "serums"), category: "serums", skinTypes: "normal,mixta,madura", price: 34.99, ingredients: "Ácido Ascórbico 20%, Ácido Ferúlico, Vitamina E, Ácido Hialurónico", isActive: true },
    { name: "Bálsamo Labial Reparador con SPF 30", slug: "balsamo-labial-reparador-spf30", description: "Bálsamo labial reparador con protección SPF 30. Hidrata y protege los labios del sol.", shortDesc: "Hidratación y protección solar", image: productImage("Bálsamo Labial", "contornos"), category: "contornos", skinTypes: "all", price: 7.99, ingredients: "Manteca de Karité, Cera de Abeja, Vitamina E, FPS 30", isActive: true },
    { name: "Aceite de Argán Puro Orgánico", slug: "aceite-argan-puro-organico", description: "Aceite de argán puro orgánico certificado. Nutre, hidrata y repara piel y cabello.", shortDesc: "Nutrición pura y natural", image: productImage("Aceite Argán", "aceites"), category: "aceites", skinTypes: "seca,normal,madura", price: 19.99, ingredients: "Aceite de Argán (100% puro, orgánico certificado)", isActive: true },
    { name: "Tónico Calmante con Manzanilla", slug: "tonico-calmante-manzanilla", description: "Tónico suave con extracto de manzanilla y aloe vera para calmar la piel irritada.", shortDesc: "Calma y reduce enrojecimiento", image: productImage("Tónico Manzanilla", "hidratantes"), category: "hidratantes", skinTypes: "sensible,normal", price: 13.99, ingredients: "Extracto de Manzanilla, Aloe Vera, Pantenol, Allantoin", isActive: true },
    { name: "Mascarilla Enzimática de Frutas", slug: "mascarilla-enzimatica-frutas", description: "Mascarilla exfoliante enzimática con extractos de papaya y piña. Renueva suavemente.", shortDesc: "Exfoliación enzimática suave", image: productImage("Mascarilla Frutas", "mascarillas"), category: "mascarillas", skinTypes: "normal,mixta", price: 15.99, ingredients: "Papaina, Bromelina, Aloe Vera, Vitamina E, Glicerina", isActive: true },
    { name: "Sérum Anti-acné con Azufre", slug: "serum-anti-acne-azufre", description: "Sérum localizado con azufre, zinc y niacinamida para tratar brotes de acné.", shortDesc: "Tratamiento puntual para brotes", image: productImage("Sérum Anti-acné", "serums"), category: "serums", skinTypes: "grasa,mixta", price: 16.99, ingredients: "Azufre 10%, Zinc PCA, Niacinamida, Aloe Vera", isActive: true },
    { name: "Crema de Manos Reparadora", slug: "crema-manos-reparadora", description: "Crema de manos intensiva con urea y manteca de karité para manos muy secas y agrietadas.", shortDesc: "Reparación intensiva para manos", image: productImage("Crema Manos", "hidratantes"), category: "hidratantes", skinTypes: "all", price: 9.99, ingredients: "Urea 10%, Manteca de Karité, Glicerina, Aloe Vera, Vitamina E", isActive: true },
    { name: "Protector Solar Capilar SPF 30", slug: "protector-solar-capilar-spf30", description: "Spray protector solar para cabello con SPF 30. Protege del sol, cloro y sal.", shortDesc: "Protección capilar solar", image: productImage("Solar Capilar SPF30", "proteccion-solar"), category: "proteccion-solar", skinTypes: "all", price: 14.99, ingredients: "FPS 30, Vitamina E, Aceite de Argán, Filtros Solares", isActive: true },
    { name: "Aceite Desmaquillante Botánico", slug: "aceite-desmaquillante-botanico", description: "Aceite desmaquillante con 8 aceites botánicos que disuelve maquillaje sin fricción.", shortDesc: "Desmaquillado suave sin irritar", image: productImage("Aceite Desmaquillante", "aceites"), category: "aceites", skinTypes: "all", price: 17.99, ingredients: "Aceite de Jojoba, Aceite de Argán, Aceite de Rosa Mosqueta, Vitamina E", isActive: true },
    { name: "Mascarilla de Oro 24K", slug: "mascarilla-oro-24k", description: "Mascarilla lujosa con partículas de oro 24K y ácido hialurónico. Efecto tensor inmediato.", shortDesc: "Lujo y efecto tensor", image: productImage("Mascarilla Oro 24K", "mascarillas"), category: "mascarillas", skinTypes: "madura,normal", price: 39.99, ingredients: "Oro 24K, Ácido Hialurónico, Colágeno, Vitamina E, Escualano", isActive: true },
    { name: "Sérum Púrpura de Corea", slug: "serum-purpura-corea", description: "Sérum coreano con extracto de camelia púrpura y niacinamida. Iluminación y poros refinados.", shortDesc: "K-beauty: luminosidad coreana", image: productImage("Sérum Corea", "serums"), category: "serums", skinTypes: "normal,mixta", price: 29.99, ingredients: "Extracto de Camelia Púrpura, Niacinamida, Ácido Hialurónico, Centella Asiática", isActive: true },
    { name: "Crema Solar con Tinte Invisible", slug: "crema-solar-tinte-invisible", description: "Protector solar con tinte invisible que se adapta a todos los tonos de piel.", shortDesc: "Protección invisible para todos", image: productImage("Solar Invisible", "proteccion-solar"), category: "proteccion-solar", skinTypes: "all", price: 22.99, ingredients: "Filtros Solares Avanzados, Vitamina E, Aloe Vera, Ácido Hialurónico", isActive: true },
    { name: "Mascarilla de Bambú Purificante", slug: "mascarilla-bambu-purificante", description: "Mascarilla con extracto de bambú y caolín que purifica sin resecar la piel.", shortDesc: "Purificación suave con bambú", image: productImage("Mascarilla Bambú", "mascarillas"), category: "mascarillas", skinTypes: "normal,mixta", price: 16.99, ingredients: "Extracto de Bambú, Caolín, Aloe Vera, Glicerina, Pantenol", isActive: true },
  ]
